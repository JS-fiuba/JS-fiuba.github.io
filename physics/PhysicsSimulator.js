...
export class PhysicsSimulator {
    ...
    addTrimeshCollider(mesh, restitution = 0.8) {
        ...
        const bodyDesc = this.physics.RAPIER.RigidBodyDesc.fixed()
        ...
        const colliderDesc = this.physics.RAPIER.ColliderDesc.trimesh(positions, indices)
